...
// ----------------------------------------------------
const stitchImages = {
  hero: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCCRdsm5d2CYa1LVp3vvcOrkfQlXoBj_zFQiApsAks0K7tC0Sv5-3eidYYcrtVWWCJzdkHJdqBG2hbKcKyQozcusN7PJ_9aeOgtL59L764X859YCdBAOjugBPjXPNtJ8uxC-SEFtauxRI6KqoFTXclwEjR1aLvb7YPP2BHcy-QhqG9Tj7rH1E64Q-2JAIPNjXJT1ZihY2nUSASWTWdmRDYztjAwST8PQCRCMKIfl1eSsR_B4AFa2PXz4A',
  featured:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDN8pxKJUcVMAM_IO0kWrq1SSMgVx521sWxWVDhyWlFnhGPvrxd8SwkzD6C1krAsrKNVaOLNpxv3beR2E3eX5sAADFhnpEys-wYQeXFkfbMh6hsLMdIA-ZqWtx2VEZ-a14mHmsueF1YCEFBp3c8k-qZzgsXHVf7Aj1w1jovQnbHL3GfOFr3vn0AsGoraQsIUE2Tg-2RhFHaw2d2hM8BAu7K5LVD8CL6YcybIu2drsv7-3AnA4vhbuVQfQ',
  intake:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCiO97W1uSySTD6MWCwZl-scIe-PKJshFxnuH6RSCCMbScDe2J7FhEZc-SkgaALtnadbYfWrvSxgXCs24T4oTyDeKGY_gBe2UV5losBreWv7gzydjJT5pR0AwiS1-Q7vf9wy_fstZ4nzmexbkaVsCJtLvaWvPap8-0tW5RXZx9N1fl4ORFPlB_7pG35kJRkZhm-Y0GvL5vGR1bX-3Lb9H4JXTZw3FwxVUG557XH-Bz2Tlw7ON1QseMyRQ',
  aiWorkshop:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCBK8eSk2kh2qGdhw7A0CeiqP_UQKWYl5RnDKtVqI5GTxGqPCaP67Pm6jFMSYBNLa2QZ_waX0xvn7XMObWlUp7HV_nnFkmUlMKm5ZlxS1HGTDXaLFFpo4O4GessMevQHjfk5tEaTSbddxmrOR5Fh-ZEsG-3aXr8dNfIrg7xvNKRciwvKW5I8M3FepeuisF1QfoxFaeifNWJBH3ngybI1v0uMzachv5XSxi9dWZFjEFywxUaBqmOwQJDaA',
  hackathon:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuD3VmSY0YupfhItc6XjnNp5mpR4ry-ZDfxCOCMWRlQlWhEYIH6yV4l4iCWU_Sz1EXFpeIm_aAoz2W_lYvz46DR4abNYRUo9xDh8Z2eLSWy_864ulEjdk2IROh9eTySFvVQm57KtNjCasiArmG1YdgK5eXNh2UScWmCOARWmGRmOyYWBBgXcqD9KOcAhcFqwLtDGb-OHba0v6TryYcp92nxc32zRbhFy2YkMLeWcOqHnubpQTSmlRmRvjA',
  achievement:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuBKCACkerlKCVm95zomVQU5Uio-rEk3-jYMlMtWAq0swJ7_lCdQ50Hp3wAIXb_mAAXXg8csWSeS2NyMB5j0GgfIoo40a8T58h0A_EFco8T-h1Anbr3-ZST1uqgSoeFfZ4vI1Rqs5f3txl24WJ49Fxxb0eTxMNTsKbMzOQYyfGyKOOXMTe7FI4OIRWatmz6mmxHfgnWE6iyaJ2FZK67nGqlOfEDCg2oKwEnUtF38LJEOtTLeAPGskkfpGg',
  announcement:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuA2qBCGiGtiEVv03nBoUOSN9iPotmMpP3JSJSRlHLWEmzf4AitDqw3OQtCAxyeHo0hwbN26AKQlTldFwJB9e4G8jab-2-CXpr_pc5Xxionr2J7coELasCnpZy0LYF4PIAZB6LcHZ8ZeY8QIrNIrBzHMuHiA65La96GJY_hW-FHfxFVvYipRkEpMx0L6VzNngHcDHPNTW0bh3xk2HD8MlxYC8PGEjz13FADMBwQasllAy7hjAR-hSPYc9Q',
  hackathons:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuBcYo4aRrJ05wWbB_gvlM8IdAn3UiLDDs84jszp1j5twc1Piywsz8m-MmUCyoiDt8pKnr40sXTIFySpgfU16ZgamPgotSsQAa5u9gh2Z2XFWcwDVV2NPC5WXyWQj1pRiDhgreiEhApxdNa0HkL4iHS6I231_8PJdydkEmYDbDVfiQTBY8f6MvnnK5izTzSSAlNPj2gRF0LlGKoKguJD9b6TOQso3f6R9F4Mnc4tvSVJDqmyQDe8CW66UA',
  peer: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBPr_zv42gSGu36pawumQoIs49TvhU8AvFGh-Rf6h7id-_9yomkHfngAf0WBpSlr-GiREVokH1EDw1dNinEZko2f7dls3ewJ79sN9LZVUG0wFqsczZ61lwim9fdmW9SmSBravgxNdHgiOHvWk8REmISs53JFnMeQB1Fu5ll7RfR2J50pzqepy5Q-soHI_Ltx2sfL09wOLD6ztQH3LilosrAJSuZj_pKNmyHbyp-18xV8tpEp6hTmZsEvw',
  teamProjects:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuBhkgQs2kmfTalAmyU5XfiQabAPEnzgYUah4fsH1tiQJ00hzTZdGS4ho5S8qLRgyxUpdzn-9B6nfFsCtmGkF96erV9lC8-TZCUj-xTswvPp2F1L0VIRI1SfIWfGWYu5fvHpFz7X0P1wnhPU6YBBYM5O2g6cINGRBUvlqA2rOCCEUrDOwbp0p2XA2md1V4LijFwMbMTLMsfv5LQlIRMd5dzEbZYJo4O6_RfUW01P7oLuzG6-DSVwPIB_Yw',
  companyTours:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuBjwLQchY3OHlTf-l5hA6i_FAdqW9vyhZ_acmgW54TAH07v5j2UZvLntPc_XEOnNl8j3NYHQE7m3B5lLlBaNhfyX07Z9LjQGGFzAzybJIRiFaTSM3lbxjGLf0WAAhdS6oES3VSvjqktxo8CWrlNoHeWBCIgCdmGMyIa6Remf3eP25IwCL62iSzLxoXapH5UpJufIppCJEqjI0ez4jGddbW3TOSljElY1Hy1QdDrl5YoHkHVhQXPdf0z6w',
  fieldVisits:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDPbzExAhQToIXTdmfSxfpuD5yTQ3H4cz0_I7AASXHMx6WJvkCpXmnj-tIFtWsKfjQx0rfKkbg57Xo5v-5iT1RMUzQy0XECg6mRmW7VfG-mgo8yfP9nnAk4__9h1xPbcOi8Fl3BRI67R0WkgWPJDzzCM7XIsXoOQlSHuaWDbxjqSEaRPX-O49fgeGINHxlzI1htC-KnnYAXwR2inVoRr9nz0LIeG2ve9fd0-sziLuebK8dGPoJ4motgw',
  galleryMeeting:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuDRypLmVKfOSYZLynek-HltJ7tqFywLvFWmyeMMT5rhcMP0vDJ-2dNp4jwS_WXntO9nOSYKjsxrKxXvGtWFqZAx5TJlsf8TD94QYtr-stFIGSCCQU9ib5U-5ZSSjBwhXj6AhlPsldQRO7uCY52MNFCtMV1AeJGPeEODPpf21kuaLeyaJFP4_6n337t7XfnBYyMlnWMUuZFDh8gkqnbff-f2OTuhNeaK4RhuvgXfDwodWaU1jMc-31CEiw',
  galleryAI:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuD6n6E_iRLO63jcIAEIAHnUwggRbkugFqsnBcRYrXrHSHrccKRoIx0foqszLeE5LRZn0XGevG49pPgKdLgi3O7icOlWhktS_9XM_AW0cKYVKuvOeBRGyY19xoSyTAKqCDuiD9KLst5S0JCt2jKyDgEq_IRmUNPiam7OsYKJR-FM5o1VrGCXVZiKfvjewzH4k79f8GpuS5UIlT6SEzNLpMeSJx2M1nf5LFXzQfAE7fiLGM1wWMuZFjsoPg',
  galleryField:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCSEismOAA8nEbGwBn8ABudBGe9DYq92L94tCWWnNVS4WpbQM6ZGEfhMthvh1Nlloa_pCtAqz-qUHlA5kGijMDRmHM0WD8laFV3dmzkReAK7Ks1A8rUVw31uMtz0bKk8OE_72n6mThkebQhIcjt4LU2a1TgMvOQo68bfUdp5TnRP5q608AknWOI0ptKJxgGEU-CzwRoVx18-CwEJQ4Y1Ys2ZpZI3PV7i6ioRO7QHa2XnV1c0CJ7j4yijQ',
  galleryProjects:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCC0Fkwfqdfuuvsq_CzV6wnIZBIddxcP6nWVTIaIHJPk9NsdpX0p0ZAvcyYdGKWZ6S8tJhZ8iL7Kg7EfFUBq0J1w6DsNuKK2mfViEcMTrWKE0SacsyO1N_jxADoQBDuOhcoGJW2m_MfyC94r-LMSsUYiX0JQ90HpIaffvfsTm9A89rbAho3XmNbTqu3w4hiroOUeIc3LyhXXhWKEyhAh-AY8gCtEkH6zWUpBcRiWFpUHGHsv3UR7sL4Sw',
  galleryGraduation:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCIOU6op52tsYoziEg9NBBNt2FEeKwVv6EkCWdmC9mGK97Q9z27XozZXP0ctP5jWiezEGSbDFYo3yIRT0gQ6WXWsAwno6Ppd8CC6U_AIRv2ihNn1ska9-uhj792zzstivO0uvUOJ8zEHN_Hd8XmkT5T4WSibTMo9gJXXU6dxhAnRdas6sLI1xXTVRBBHQzwmLcEsxu2i7jPNmhXON51gXdKwMlXSobssu6gmyMjHZ6HAT1RM3dEbxQMfA',
};
...
export const latestNews = [
  {
    title: 'Welcome to Intake 48',
    type: 'NEWS',
    date: 'SEP 10, 2026',
    description: 'A new generation of software developers begins their journey at SD.',
    image: stitchImages.intake,
    tone: 'dark',
  },
  {
    ...
    type: 'WORKSHOP',
    date: 'SEP 08, 2026',
    description: 'React × Node.js × RAG hands-on workshop session.',
    image: stitchImages.aiWorkshop,
    tone: 'teal',
  },
  {
    title: 'SD Students at Techstars Hackathon',
    type: 'STUDENT ACTIVITY',
    date: 'AUG 28, 2026',
    description: 'Innovative ideas. Real impact.',
    image: stitchImages.hackathon,
    tone: 'blue',
  },
  {
    title: 'SD Team Wins 1st Place',
    type: 'ACHIEVEMENT',
    date: 'AUG 20, 2026',
    description: 'Congratulations to our students for winning the AI Innovation Challenge.',
    image: stitchImages.achievement,
    tone: 'red',
  },
  {
    title: 'Registration for Fall Workshops is Open',
    type: 'ANNOUNCEMENT',
    date: 'AUG 15, 2026',
    description: 'Join our upcoming technical sessions.',
    image: stitchImages.announcement,
    tone: 'orange',
  },
];
...
export const upcomingEvents = [
  {
    ...
    title: 'SD Career Day',
    description:
      'Smart Village, Cairo. Meet industry experts and explore career opportunities at SD.',
    tag: 'CAREER',
    featured: true,
  },
  {
    ...
    description: 'SD Headquarters. Students present their capstone projects.',
    tag: 'PRESENTATION',
  },
  {
    month: 'OCT',
    ...
    description: 'Online hands-on cloud session with real-world labs.',
    tag: 'WORKSHOP',
    tagTone: 'teal',
  },
  {
    ...
    posted: 'AUG 26, 2026',
    title: 'Alumni Panel',
    description: 'Smart Village, Cairo. Career stories and insights from SD alumni.',
    tag: 'TALK',
  },
];
...
export const workshops = [
  {
    ...
    description: 'Best practices for collaborative development.',
    duration: '2 HOURS',
    level: 'BEGINNER',
    tone: 'red',
  },
  ...
  },
  {
    ...
    description: 'Build cross-platform apps with clean architecture.',
    duration: '3 HOURS',
    level: 'INTERMEDIATE',
    tone: 'teal',
  },
  {
    ...
    description: 'Tips, practice, and real examples from tech leads.',
    duration: '2 HOURS',
    level: 'ALL LEVELS',
    tone: 'green',
  },
...
export const studentLife = [
  {
    ...
    image: stitchImages.hackathons,
    size: 'large',
  },
  { title: 'Peer Discussions', image: stitchImages.peer, size: 'small' },
  {
    title: 'Team Projects',
    description: 'Learn together. Build together.',
    image: stitchImages.teamProjects,
    size: 'small',
  },
  { title: 'Company Tours', image: stitchImages.companyTours, size: 'small' },
  {
    title: 'Field Visits',
    description: 'Real-world exposure.',
    image: stitchImages.fieldVisits,
    size: 'small',
  },
];
...
export const achievements = [
  {
    number: '01',
    label: 'PROJECT AWARD',
    text: 'SD Team wins first place in the AI Innovation Challenge.',
    icon: 'gift',
    tone: 'red',
  },
  {
    number: '02',
    label: 'HACKATHON',
    text: 'Students selected for Techstars Hackathon.',
    icon: 'group',
    tone: 'teal',
  },
  {
    number: '03',
    label: 'CERTIFICATION',
    text: 'SD students complete Google Cloud certifications.',
    icon: 'verified',
    tone: 'teal',
  },
  {
    number: '04',
    label: 'COMPETITION',
    text: 'Our team reaches the finals in Egypt Tech Challenge.',
    icon: 'trend',
    tone: 'dark',
  },
];
...
export const featuredProjects = [
  {
    title: 'AquaMetrics',
    track: 'AI & Intelligent Systems',
    description: 'An AI-powered athlete management platform.',
    image: stitchImages.galleryProjects,
  },
  {
    title: 'EduConnect',
    track: 'Full Stack Development',
    description: 'A smart learning platform for students and instructors.',
    image: stitchImages.teamProjects,
  },
  {
    title: 'MediTrack',
    track: 'Mobile Cross Platform',
    description: 'Healthcare management made simple and intuitive.',
    image: stitchImages.galleryAI,
  },
];
...
export const announcements = [
  {
    status: 'NEW',
    title: 'Intake 48 Orientation Schedule',
    detail: 'September 21, 2026',
    tone: 'red',
  },
  {
    status: 'IMPORTANT',
    title: 'Registration for AI Workshop is Now Open',
...
export const gallery = [
  { title: 'Team Meeting', date: 'Sep 2026', image: stitchImages.galleryMeeting },
  { title: 'AI Workshop', date: 'Aug 2026', image: stitchImages.galleryAI },
  { title: 'Field Visit', date: 'Jul 2026', image: stitchImages.galleryField },
  { title: 'Project Demos', date: 'Aug 2026', image: stitchImages.galleryProjects },
  { title: 'Graduation', date: 'Jun 2026', image: stitchImages.galleryGraduation },
];

export const timeline = [
  { month: 'JUN', title: 'Graduation Projects' },
  { month: 'JUL', title: 'AI Workshop Series' },
  { month: 'AUG', title: 'Project Showcase' },
  { month: 'SEP', title: 'Intake 48 Begins', active: true },
  { month: 'OCT', title: 'Career Day' },
];

function HeroBranding() {
  return (
    <>
      ...
      <div className="hero1  w-1/2 px-10 py-8 z-10 h-full">
        <div className="max-w-3xl flex flex-col items-start gap-7">
          ...
          <p className="deshero font-body-lg text-base sm:text-lg lg:text-xl text-white/90 leading-relaxed max-w-2xl font-normal">
            The Software Development Department at ITI develops software engineers through hands-on
            learning, real-world projects, modern technologies, and nationwide collaboration.
          </p>

            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-14">
              ...
              <div className="flex flex-col gap-6 lg:col-span-7">
                ...
                <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
                  ...
                  technical minds through intense, studio-style immersion. From comprehensive
                  9-month professional diplomas and agile 4-month career accelerators to
                  pre-university summer academies, our curricula bridge theory with uncompromising
